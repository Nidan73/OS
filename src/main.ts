...
const LESSONS_META: LessonMeta[] = [
  ...
  { id: 9, slug: 'lesson-09', chapterSlug: 'lecture-07', title: 'When Late Means Failed', blurb: 'A siren, a crowd, a crew and a closing gate — drag the latency lengths until the response bar overshoots the deadline.' },
